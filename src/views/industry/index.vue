...
const tags = ref([
    { id: "45e1cd70-350a-4ff0-8550-fe19e201d3a9", text: '行业信息', type: '2', icon: 'icon-hangye' },
    { id: "bd0c3431-c62b-4c22-bde5-906795644070", text: '行业标准', type: '2', icon: 'icon-wodekecheng' },
    { id: "ff772cd3-5e22-489e-b923-3b7f96f7993c", text: '就业信息', type: '2', icon: 'icon-anli' },
    { id:"b0917cb3-ba7d-432b-aaaa-0d4936ab18a8", text: '企业文化', type: '1', icon: 'icon-wenhua' },
    { id:  "769e3ef6-2fe3-4dbe-a4c0-82c18dd7b501", text: '行业新技术', type: '2', icon: 'icon-jishufuwu' }
]);
const total = ref(100);
